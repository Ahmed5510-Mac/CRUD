...
productPriceInput.addEventListener("keyup",function(){
    ...
    validateproductName(productPriceInput.value)
})
//=============================================================================
let person=function (pName ,page ,psalary ,pGender,oldFrind)
{
    this.name=pName;
    this.age=page;
    this.gender=pGender;
    this.oldFrind=oldFrind;
...
let p1 =new person('ahmed',13,3000,mail ,['sayed' ,'hima'])